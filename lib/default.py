...
if mode == "Defaults":
    sourcelist = ['4kmovieto','0123putlocker','123fox','123hbo','123hulu','123moviehd','123movies','123movies4u','123moviesex','123moviesfree','123moviesfreenow','123movieshubvip','300mbdownload','animetoon','bnwmovies','cartoonhd','coolmoviezone','fmovies','freefmovies','freeputlockers','furk','gostream','gowatchseries','Hdmto','hdpopcorns','kattv','l23movies','library','moviesonline','myprojectfreetv','openloadmovie','ororo','plocker','primewire','putlocker','reddit','rlsbb','seehd','series9','seriesfree','seriesonline','solarmovies','tvbox','videoscraper','vidics','watchseries','xwatchseries']
    toggleAll(params['setting'], params['open_id'], sourcelist)
